...
public class DadosFalsos {
    ...
    public static List<Livro> listaDeLivros() {
        return List.of(
            ...
            new Livro(2L, "Duna", "Frank Herbert", "Ficção", 1965, 
                      "Editora Aleph", "2ª Edição", "978-8576572008", 680, 
            ...
            new Livro(3L, "Dom Casmurro", "Machado de Assis", "Literatura Clássica", 1899, 
                      "Garnier", "1ª Edição", "978-8535902778", 256, 
            ...
            new Livro(4L, "O Poder do Hábito", "Charles Duhigg", "Autoajuda", 2012, 
                      "Objetiva", "1ª Edição", "978-8539004119", 408, 
            ...
            new Livro(5L, "1984", "George Orwell", "Ficção", 1949, 
                      "Companhia das Letras", "1ª Edição", "978-8535914849", 416, 
            ...
            new Livro(6L, "O Senhor dos Anéis", "J.R.R. Tolkien", "Fantasia", 1954, 
                      "HarperCollins", "2ª Edição", "978-8595084773", 1200, 
            ...
            new Livro(7L, "Memórias Póstumas de Brás Cubas", "Machado de Assis", "Literatura Clássica", 1881, 
                      "Tipografia Nacional", "1ª Edição", "978-8535910667", 224, 
            ...
            new Livro(8L, "Ansiedade: Como Enfrentar o Mal do Século", "Augusto Cury", "Autoajuda", 2013, 
                      "Benvirá", "1ª Edição", "978-8582400784", 160, 
            ...
            new Livro(9L, "O Nome do Vento", "Patrick Rothfuss", "Fantasia", 2007, 
                      "Editora Arqueiro", "1ª Edição", "978-8580410051", 656, 
            ...
            new Livro(10L, "Fahrenheit 451", "Ray Bradbury", "Ficção", 1953, 
                      "Biblioteca Azul", "1ª Edição", "978-8525052247", 216, 
